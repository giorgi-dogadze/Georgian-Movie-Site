...
<body>
	...
	<content>
		...
		echo "<table>";
		echo "<tr><th>"."ფილმის სახელი"."</th><th>"."გამოშვების წელი"."</th><th>"."ფილმის აღწერა"."</th><th>"."წაშლა"."</th><th>"."რედაქტირება"."</th></tr>";
		while($row = $result->fetch_row())
		{
			$id = $row[0];
			echo "<tr><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td><a href = 'delete.php?delete_id=".$id."'>წაშლა</a></td><td><a href = 'update.php?update_id=".$id."'>რედაქტირება</a></td></tr>";
		}
		...
		echo "</table>";
		 ...
		 <br>
		 <br>
		 <h2 style="text-align: center;"><a href="about_user.php">ინფორმაცია მომხმარებელზე</a> </h2>
		 <h2 style="text-align: center;"><a href="index.php">უკან დაბრუნება</a> </h2>
